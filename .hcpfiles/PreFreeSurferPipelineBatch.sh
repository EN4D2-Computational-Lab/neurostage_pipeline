...
main()
{
	...
	EnvironmentScript="$PIPELINE_BASE/HCPpipelines/Examples/Scripts/SetUpHCPPipeline.sh" # Pipeline environment script
	...
	for Subject in $Subjlist ; do
		echo "PreFreeSurferPipelineBatch started for the subject=${Subject}"
		...
		FNIRTConfig="/opt/fsl/etc/flirtsch/T1_2_MNI152_2mm.cnf"
		...
		echo "PreFreeSurferPipelineBatch ended for the subject=${Subject}"
		echo ""
		echo ""
