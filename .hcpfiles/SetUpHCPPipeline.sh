...
# export HCPPIPEDIR=/mnt/data_raid/Gaurav/neurostage_pipeline/HCPpipelines
...
# export MSMBINDIR="${HOME}/pipeline_tools"
# export MATLAB_COMPILER_RUNTIME=/usr/local/MATLAB/R2025b/
# export FSL_FIXDIR=/usr/local/fix
# If a suitable version of wb_command is on your $PATH, CARET7DIR can be blank
# export CARET7DIR=/mnt/data_raid/Gaurav/neurostage_pipeline/workbench/bin_linux64
...
# export FSLDIR=/mnt/data_raid/Gaurav/neurostage_pipeline/fsl/
